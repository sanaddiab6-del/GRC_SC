...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('data_provided', sa.JSON()),
    ...
    op.create_table(
        ...
        sa.Column('data_types_affected', sa.JSON()),
        sa.Column('affected_individuals', sa.JSON()),
    ...
    op.create_table(
        ...
        sa.Column('description_en', sa.Text(), nullable=False),
        sa.Column('description_ar', sa.Text(), nullable=False),
        sa.Column('detection_steps', sa.JSON(), nullable=False),
        sa.Column('containment_steps', sa.JSON(), nullable=False),
        sa.Column('eradication_steps', sa.JSON(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('next_review_date', sa.DateTime()),
        sa.Column('closed_at', sa.DateTime()),
        sa.Column('related_controls', sa.JSON()),
    ...
    op.create_table(
        ...
        sa.Column('compliance_certificates', sa.JSON()),
