...
<div data-testid="sidebar" class="sidebar">
	<aside
		class="flex w-64 shadow-xl transition-all duration-300 fixed h-screen overflow-visible top-0 left-0 z-20 {classesSidebarOpen(
			open
		)}"
		style="background: linear-gradient(180deg, #1a2332 0%, #243247 100%);"
	>
