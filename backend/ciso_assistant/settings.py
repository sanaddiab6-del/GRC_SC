...
# Access tokens are short-lived (15 min); refresh tokens survive 7 days.
# Refresh tokens are rotated on every use and the old token is blacklisted
...
SIMPLE_JWT = {
    ...
    # Lean token class
    "TOKEN_OBTAIN_SERIALIZER": "iam.jwt_auth.GRCTokenObtainPairSerializer",
    # JTI claim for token tracking
    "JTI_CLAIM": "jti",
}
